...
def data_process(gps_ok, gps_not_ok, channel):
    ...
    for files, ticks, time, p in gps_ok:
        ...
        for idx, file in enumerate(files):
            ...
            #print('good gps', file, first_time, last_time)
...
def gps_process(filelist):
    gps_ok, gps_not_ok = read_gps_from_fits(filelist)
    ...
    #print(len(gps_ok), len(gps_not_ok))
...
def process_ok_gps(data):
    ...
    #files_duplicate, _, _, _ = list(zip(*gps_ok_duplicate))
    #print(files)
    #print(files_duplicate)
    #print(gps_not_ok[0])
    #print('after validation', len(gps_ok))
    return gps_ok, gps_not_ok[0]
